...
/******/ 	return __webpack_require__(__webpack_require__.s = "./launcher-connector-channel/index.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./launcher-connector-channel/channel.js":
/*!***********************************************!*\
  !*** ./launcher-connector-channel/channel.js ***!
  \***********************************************/
/*! exports provided: initChannel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initChannel", function() { return initChannel; });
...
async function initChannel({
  ...
  const channel = await new Promise(resolve => {
    jschannel__WEBPACK_IMPORTED_MODULE_0___default.a.build({
      window: target,
      origin: "*",
      scope: scope,
      onReady: channel => {
...
/***/ "./launcher-connector-channel/index.js":
/*!*********************************************!*\
  !*** ./launcher-connector-channel/index.js ***!
  \*********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils */ "./launcher-connector-channel/utils.js");
/* harmony import */ var _channel_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./channel.js */ "./launcher-connector-channel/channel.js");



function setupA5(params = {}) {
  window.A5 = Object.assign({}, window.A5, params);
}

async function initConnection(channel) {
...
function loadEngine(paths) {
  return Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getScriptList"])(paths);
}

function initEngine(channel, connection) {
  return new a5.Engine({
    channel
  }).initialize({
    lrs_activity_id: connection.id,
    lo_without_controls: connection.loWithoutControls,
    lo_with_external_result_screen: connection.loExternalResultScreen,
    lms_state: connection.state,
    lo_profile: connection.loProfile
  });
}

Object(_utils__WEBPACK_IMPORTED_MODULE_0__["domReady"])(async function () {
  try {
    const scope = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getURLParameter"])('scope');
    const channel = await Object(_channel_js__WEBPACK_IMPORTED_MODULE_1__["initChannel"])(Object.assign({}, scope ? {
      scope
    } : null));
    const connection = await initConnection(channel);
    ...
    await loadEngine([A5.ENGINE_ROOT + 'player.js']);
    await initEngine(channel, connection);
  } catch (error) {
...
/***/ "./launcher-connector-channel/utils.js":
/*!*********************************************!*\
  !*** ./launcher-connector-channel/utils.js ***!
  \*********************************************/
/*! exports provided: domReady, getScriptList, getScript, getURLParameter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "domReady", function() { return domReady; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getScriptList", function() { return getScriptList; });
...
function getScriptList(list) {
  return Promise.all(list.map(src => getScript(src)));
}
...
/******/ });
//# sourceMappingURL=../dist-maps/launcher-connector-channel.bundle.js.map