...
a5.dp.info = {
  engine: `${a5.Engine.version || 'development'} (recommended: buckminster-34.0.0-rc.1.0)`,
  root: 'core-release34-2.4.1'
};
...
_.extend(a5.dp.config, {
  ...
  annotationsDefaultTool: 'pointer',            // String         Default annotations toolbar tool (pointer | pen | brush | stickynote) (default: pointer)
      ...
      _onInteractionStart: function(interaction) {
        ...
        if (a5.core.config.loToolbarMaxWidthRatio) {
          if (this._hasVisibleAttachments(interaction)) {
            const loToolbarWidthRatio = 100 * $(locators.loToolbar).width() / interaction.contentWrap.width();
...
_.extend(a5.core.config, {
  ...
  loToolbarMaxWidthRatio: 30,                   // Integer (%)    Toggle the activity--hasWideAttachments class if the attachments width is higher than the established ratio
...
_.extend(a5.dp.info, {
  child2: 'richmond-rdp-secondary-3.5.1'
});
