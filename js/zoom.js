...
//TRABAJAR EN ESTA CONDICION CUANDO EL USUARIO HACE MINUS
    $("#zoomBTN").css('background-image', 'url(images/iconos/zoom_mas.png)');
    $(".lc-picker").css("visibility","visible")
    $("#selectorLibros").css("visibility","visible")
    escondeBarra(0,13);
//Muestra iCONOS Seccion 1
    $(".lc-picker").css("display","block")
    $(".lc-options").css("display","block")
    $( "#aviso" ).css("display","block")
    $('.lc-drawing').css('cursor', '');
    $(".lc-drawing").off("click");
    $(".lc-pick-tool:eq(0)").click()
    zoom.out;
//DESACTIVA ZOOM
